...
const ReceiptForm: React.FunctionComponent<ReceiptFormProps> = (props) => {
    ...
    useEffect(() => {dispatch(getProducts())}, [dispatch] )
        ...
        if(date&&(units>0)){
            ...
            const productUpdated = {...product, availableUnits: product.availableUnits+addReceipt.units}
        ...
        return (
            <div>
                ...
                <select className='controls' id="providers" name="providers" onChange={(e) => selectProdOnList(e)}>
